...
let runWorkout1 = RunningWorkout(distance: 1609.62, time: 1200.5)
let swimWorkout1 = SwimmingWorkout(distance: 50, time: 900.9)
simpleWorkoutDescription(workout: runWorkout1)
simpleWorkoutDescription(workout: swimWorkout1)
