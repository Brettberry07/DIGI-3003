...
let runWork = RunningWorkout(distance: 252.34, time: 135)
let swimWork = SwimmingWorkout(distance: 100, time: 45)

simpleWorkoutDescription(workout: runWork)
simpleWorkoutDescription(workout: swimWork)
/*:
