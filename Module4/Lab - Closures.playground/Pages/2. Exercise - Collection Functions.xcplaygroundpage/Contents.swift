...
var people: [String] = ["Dad","Mom","Connor","Chloe"]
let sortedCollection = people.sorted(by: forwards(_:_:))
...
let sortedCollection2: [String] = people.sorted(by: { (name1: String, name2: String) -> Bool in
    print("\(name1)")
    print("\(name2)")
    return name1 < name2
})
...
let sortedCollection3 = people.sorted {
    print($0)
    print($1)
    return $0 < $1
}
